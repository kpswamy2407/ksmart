<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/collections/docinfo">
		<vtiger_xcomplaintssurveydocinfo>
			...
			<documenttype>xComplaintsSurvey</documenttype>
	...
	<xsl:template match="/collections/documentcontent/NewDataSet/Table">
		<vtiger_xcomplaintssurvey>
			<complaintssurveycode><xsl:value-of select="complaintssurveycode" /></complaintssurveycode>
